...
class ClientsController extends Controller
{
    ...
    {
        $cellData[] = ['姓名', '客户来源', '客户状态', '客户品牌', '性别', '电话', '微信', '民族', '身份证号码', '标签', '籍贯', '现住地址', '首次合作时间', '维护人编号', '备注'];
        $cellData[] = ['例：张三', '例：朋友介绍', '-1:黑名单，0:潜在客户，1:合作中，2:合作完毕', '杰尼威尼专卖,JV专卖(多个品牌用英文逗号隔开)', '例：女', '例：13333333333', '例：weixin（选填）', '例：汉族', '例：510111199905065215', 'VIP客户,市代客户（多个标签用英文逗号分开）', '例：四川', '例：四川省成都市金牛区万达广场（选填）', '例：2010-10-10', '例：110105（选填）', '例：备注（选填）'];
        $fileName = '客户资料导入模板';
