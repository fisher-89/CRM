...
class ClientsController extends Controller
{
    ...
    public function example()
    {
        ...
        $cellData[] = ['例：张三', '例：朋友介绍', '黑名单,潜在客户,合作中,合作完毕(选择一种)', '杰尼威尼专卖,JV专卖(多个品牌用英文逗号分开)', '例：女', '例：13333333333', '例：weixin（选填）', '例：汉族', '例：510111199905065215', 'VIP客户,市代客户（多个标签用英文逗号分开）', '例：四川', '例：2010-10-10', '例：110105（选填）', '例：备注（选填）'];
        $fileName = '客户资料导入模板';
